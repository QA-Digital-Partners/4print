...
const Button4P = ({buttonText, buttonBgAnimation, textColor, iconOption, buttonLink}) => {
    ...
    const iconList = ['ib-white-blue.svg', 'ib-blue-white.svg', 'ir-white-blue.svg', 'ib-link-blue-white.svg', 'ib-white-red.svg', 'ib-blue-white-ar.svg', 'ib-white-blue-call.svg']
  return (
    <>
